...
ActiveRecord::Schema.define(:version => 20120321172080) do
  ...
  create_table "alchemy_localizations", :force => true do |t|
    t.integer  "domain_id"
  ...
  add_index "alchemy_localizations", ["language_id"], :name => "index_alchemy_localizations_on_language_id"
