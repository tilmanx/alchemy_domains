...
describe Alchemy::PagesHelper do
	...
	describe "#language_switcher" do
		...
		it "should return nil when having only one public language for the current domain" do
			helper.language_switcher.should be nil
		end

		context "with two public languages assigned to the current domain and two language_roots" do
